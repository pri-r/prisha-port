...
const Projects = () => {
  return (
    <div className="projects">
      ...
      <div class="capy">
        <div class="capy-pic">
            <a href="https://pri-r.github.io/Catch-the-Capy-Game/" target="_blank"> <img src="./prisha-port/public/capy.png"/> </a>
        </div>
        <p>
      ...
      <div class="website">
          <div class="web-pic">
              <a href="https://pri-r.github.io/technical-challange-devsoc-24t1-yay/" target="_blank"> <img src="./prisha-port/public/web.png"/> </a>
          </div>
        <p>
      ...
      <div class="Boo">
          <div class="web-pic">
              <a href=""> <img src="./prisha-port/public/boo.png"/> </a>
          </div>
        <p>
